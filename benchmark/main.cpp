...
int main(int argc, char **argv) {
  ...
  desc.add_options()("index-path,ip",
                     bpo::value<std::string>(&index_path)
                         ->default_value("/tmp/tantivy_search/index_path"),
                     "tantivy index files path")(
      "query-term-path,qtp",
      bpo::value<std::string>(&query_term_path)
          ->default_value("/tmp/tantivy_search/query_terms.json"),
      "query terms file path")("help", "this is help message");
