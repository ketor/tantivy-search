...
//
//   +---------------------+            +--------------------------+
//   | TopDocsWithFilter64   |<-----------| TopScoreSegmentCollector |
//   +---------------------+            +--------------------------+
//
...
impl TopDocsWithFilter64 {
    // limit for result size.
    pub fn with_limit(limit: usize) -> TopDocsWithFilter64 {
    ...
    pub fn with_searcher(mut self, searcher: Searcher) -> TopDocsWithFilter64 {
        self.searcher = Some(searcher.clone());
        self
    }

    // field which store origin text content.
    pub fn with_text_fields(mut self, fields: Vec<Field>) -> TopDocsWithFilter64 {
        self.text_fields = Some(fields.clone());
        self
    }

    // whether need return origin text content.
    pub fn with_stored_text(mut self, need_text: bool) -> TopDocsWithFilter64 {
    ...
    #[allow(dead_code)]
    pub fn with_initial_heap_size(mut self, initial_heap_size: usize) -> TopDocsWithFilter64 {
...
impl fmt::Debug for TopDocsWithFilter64 {
...
impl Collector for TopDocsWithFilter64 {
