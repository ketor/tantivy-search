...
void test_tokenizer_create() {
  ...
  tantivy_logger_initialize("./log/", "info", false, tantivy_log_callback, true,
                            true);
  TantivySearchIndexW *indexW =
      tantivy_create_index_with_language("./temp", "chinese");
  tantivy_index_doc(indexW, 0,
  ...
  tantivy_index_doc(indexW, 17,
                    "在医学领域，化学化合物的作用至关重要，它们在许多重大医疗突"
                    "破中扮演了核心角色。");
  tantivy_index_doc(indexW, 18,
                    "当代哲学家在探讨人工智能时代的伦理道德问题，对机器与人类的"
                    "关系进行深刻反思。");
  tantivy_index_doc(indexW, 19,
